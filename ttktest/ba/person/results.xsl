...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/testResults">
        ...
        <head>
            ...
            <style type="text/css"><![CDATA[
                ...
                * { margin: 0; padding: 0 }
                ...
                #left-panel { position: absolute; left: 0; top: 1; bottom: 0; width: 300px; height: 93%; overflow: auto; background: #dee4ea }
                ...
                #right-panel { position: absolute; right: 0; top: 1; bottom: 0; left: 301px; height: 93%; overflow: auto; background: white }
                ...
                #right-panel pre.data { white-space: pre; word-wrap: break-word }
                ...
                #top-panel { position: absolute; right: 0; top: 0; bottom: 0; width: 100% ; height: 7%; overflow: auto; background: #e6e6e6 }
        ...
        <body>
			...
			<!--				<hr size="1" width="99.8%" align="center" />	-->
